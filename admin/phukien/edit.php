...
<div class="container_admin_add">
    ...
    <form action="index.php?action=updatepk" method="post" enctype="multipart/form-data">
            ...
            <div class="row_admin_btn">
                ...
                <a href="index.php?action=listpk"><input type="button" name="danhsach" value="Danh sách"></a>
            </div>
            <!-- <?php
