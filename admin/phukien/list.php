        ...
        <table>
         ...
         <?php
            ...
            foreach ($listsanpham as $sanpham) {
                ...
                $xoapk = "index.php?action=xoapk&id=".$id;
                ...
                echo '<tr>
                    ...
                    <td>'.$img.'</td>
                    <td>'.$mota.'</td>
                    <td><a href="' . $suapk . '"><input type="button" class="button_sua_admin" value="Sửa"></a> <a href="' . $xoapk . '"><input type="button" class="button_list_admin" value="Xóa"></a></td>
                </tr>';
            }
        ?> 
        </table>
