...
<div class="container_admin_add">
    <div class="tittle_admin_add">
        <h1>CẬP NHẬT TRANG PHỤC</h1>
    </div>
    <div class="content_admin_add">
    <form action="index.php?action=updatetp" method="post" enctype="multipart/form-data">
            ...
            <div class="row_admin_btn">
                ...
                <a href="index.php?action=listtp"><input type="button" name="danhsach" value="Danh sách"></a>
            </div>
            <!-- <?php
